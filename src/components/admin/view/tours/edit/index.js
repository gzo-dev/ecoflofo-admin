    ...
    const handleSubmit = async (event) => {
        try {
            ...
            if (image) {
                ...
                const data = {
                    tour_id: self.tour_id, name, status, price, discountPer, desc, departure, departureText, destination, destinationText, content, type, image:  imageUrl.file_path, kindof
                }
                ...
                const data = {
                    tour_id: self.tour_id, name, status, price, discountPer, desc, departure, departureText, destination, destinationText, content, type, kindof
                }
                const result = await apiEditTour({ ...data })
                swal("Thông báo", "Cập nhật thành công", "success")
                setLoading(false)
